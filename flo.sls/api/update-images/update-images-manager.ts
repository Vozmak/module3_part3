...
export class UploadImagesManager {
  ...
  async updateImages(uploadInfo: S3EventRecord, updateImagesCurlService: UpdateImagesCurlService): Promise<void> {
    ...
    return this.service.updateImages(key, imageObject, S3, updateImagesCurlService);
  }
}
